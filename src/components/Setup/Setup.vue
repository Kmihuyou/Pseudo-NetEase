<template>
  <div >
    ...
    >
      <div class="flex items-center justify-between">
        <div class="flex items-center">
          <div
            class="w-[7vw] h-[7vw] rounded-[50%] mr-[2vw] bg-[#f4f4f1] flex items-center justify-center"
          >
            <img
    ...
    <!--  -->
    <div data-v-7bfda910="">
      <div class="dark:bg-[#151515] bg-[#f1f1f1] scroll-wrapper">
              ...
              >
                <div class="flex items-center">
                  ...
                  >
                    <path
                      fill="currentColor"
                      d="M11 18h2v-2h-2v2m1-12c-2.2 0-4 1.8-4 4h2c0-1.1.9-2 2-2s2 .9 2 2c0 2-3 1.8-3 5h2c0-2.2 3-2.5 3-5c0-2.2-1.8-4-4-4m7-1v14H5V5h14m0-2H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2Z"
                    ></path>
                  </svg>
                  <span
                    class="dark:text-[#f0f0f0] text-[color:#333333] text-[3.5vw] ml-[2.73vw]"
                    ...
                    <g fill="currentColor" fill-opacity="0">
                      ...
                      >
                        <animate
                          ...
                          begin="0.7s;iconifyVue1.begin+6s"
                          dur="0.4s"
                          values="0;1"
                        ></animate>
                        <animate
...
export default {
  computed: {
    ...
    isDarkMode:{
      ...
      set(value){
        this.$store.commit("changDarMode",value)
      }
    }
  },
  methods:{
