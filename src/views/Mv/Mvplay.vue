<template>
  <div
    class="bg-black w-screen h-screen pb-[-12vw] flex flex-wrap absolute "
  >
    <!-- <div
    ...
    <div class="w-[100%] h-[54vw] absolute top-[12%]">
      <video v-if="resources" :src="resources.data.data.url"></video>
    </div>
    <div class="w-[100%] absolute bottom-[0vw]">
      <div class="flex justify-between px-[4vw] items-end pb-[3vw]">
        <div class="flex-1 mr-[10vw]">
          <div class="flex items-center mb-[3vw]">
            <img
              src="http://p1.music.126.net/CsGY6JmX21cxa-5DZKIqpQ==/109951164546544248.jpg"
              alt=""
        ...
        <div class="w-[10vw]">
          <div class="flex items-center flex-wrap justify-center mb-[4vw]">
            ...
            <span class="text-[#eaeaea] text-[3vw]">1910</span>
          </div>
          <div class="flex items-center flex-wrap justify-center mb-[4vw]">
            <svg
              xmlns="http://www.w3.org/2000/svg"
            ...
            <span class="text-[#eaeaea] text-[3vw]">234</span>
          </div>
          <div class="flex items-center flex-wrap justify-center mb-[4vw]">
            <svg
              xmlns="http://www.w3.org/2000/svg"
            ...
            <span class="text-[#eaeaea] text-[3vw]">293</span>
          </div>
          <div class="flex items-center flex-wrap justify-center mb-[4vw]">
            <svg
              xmlns="http://www.w3.org/2000/svg"
          ...
          <div class="relative flex items-center justify-center">
            ...
            <!-- <img
              ...
              src="http://p1.music.126.net/2b8wjb10WyTqGXZygG1_VA==/109951169103151905.jpg"
            /> -->
          </div>
        </div>
      </div>
      <div
        ...
        style="display: none"
      >
        <span class="text-[#ffffff]">00:01</span>
      ...
      >
        <div class="vue-slider-rail">
          ...
          ></div>
          <div
            aria-valuetext="0.7294973791004397"
            class="vue-slider-dot"
            role="slider"
            aria-valuenow="0.7294973791004397"
            aria-valuemin="0"
            aria-valuemax="100"
...
<script>
import { MvlistPlay } from "@/service"
export default {
    data(){
        return {
            resources:'',
    ...
    async created() {
      ...
      const [err, res] = await MvlistPlay({id:this.$route.query.id});
      if (!err) this.resources = res
